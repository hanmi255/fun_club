...
{
    setWindowTitle("关于我们");
    setWindowIcon(QIcon(":/Image/Image/Moon.jpg"));
    ...
    pixCard->setCardImage(QImage(":/Image/Image/Moon.jpg"));
    ...
    ElaText* thanksText = new ElaText("bilibili@_Ela");
    thanksText->setWordWrap(false);
    thanksText->setTextPixelSize(14);
    ...
    textLayout->addWidget(thanksText);
